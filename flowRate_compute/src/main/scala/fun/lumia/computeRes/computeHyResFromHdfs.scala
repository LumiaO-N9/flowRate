...
object computeHyResFromHdfs extends SparkTool {
  /**
   * 在run方法里面编写spark业务逻辑
   */
  override def run(args: Array[String]): Unit = {
    ...
    val pathStr = ComputeConstant.SPARK_STREAMING_WRITE_PATH + "/" + ComputeConstant.HANG_YAN_KAFKA_TOPIC_NAME + "/"
    ...
    //    println("********************")
    // 28800000‬
    val min = timeDistrictStart - 28800000
    val max = timeDistrictEnd - 28800000
