...
object computeFhResFromHdfs extends SparkTool {
  /**
   * 在run方法里面编写spark业务逻辑
   */
  override def run(args: Array[String]): Unit = {
    ...
    //当前计算时的时间区间
    val delayMinute: Int = 10 // minutes
    ...
    val pathStr = ComputeConstant.SPARK_STREAMING_WRITE_PATH + "/" + ComputeConstant.FONSVIEW_KAFKA_B2B_TOPIC_NAME + "/"
